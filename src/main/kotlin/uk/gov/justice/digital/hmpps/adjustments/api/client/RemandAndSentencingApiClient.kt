...
class RemandAndSentencingApiClient(@Qualifier("remandAndSentencingApiWebClient") private val webClient: WebClient) {
  ...
  fun getSentenceTypeDetails(nomisSentenceReference: String): SentenceDetailResponse? {
    log.info("Fetching recall type for nomisSentenceReference: $nomisSentenceReference")
    return webClient.get()
      .uri { uriBuilder ->
